...
export default function Recipes() {
    ...
    const load = async () => {
      ...
      if (recipeId) {
        ...
        if (foundRecipe) {
          ...
          if (currentUser) {
            setFavorite(isFavorite(currentUser.id || currentUser.username, recipeId));
          }
        }
      }
    };
  ...
  const toggleFavorite = () => {
    ...
    if (favorite) {
      removeFavorite(user.id || user.username, recipeId);
      setFavorite(false);
      toast.success('Removed from favorites');
    } else {
      addFavorite(user.id || user.username, recipeId);
      setFavorite(true);
